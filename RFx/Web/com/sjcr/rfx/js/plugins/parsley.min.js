...
(function(global, factory) {
  ...
  ParsleyAbstract.prototype = {
    ...
    asyncIsValid: function asyncIsValid() {
      ParsleyUtils__default.warnOnce(
        "asyncIsValid is deprecated; please use whenIsValid instead"
      );
  ...
  ParsleyUI.prototype = {
    ...
    getErrorsMessages: function getErrorsMessages(fieldInstance) {
      ...
      for (var i = 0; i < fieldInstance.validationResult.length; i++)
        messages.push(
          fieldInstance.validationResult[i].errorMessage ||
    ...
    setupForm: function setupForm(formInstance) {
      ...
      formInstance.$element.on(
        ...
        $.proxy(formInstance.onSubmitButton, formInstance)
      );
  ...
  ParsleyForm.prototype = {
    ...
    validate: function validate(group, force, event) {
      return ParsleyForm__statusMapping[
        this.whenValidate(group, force, event).state()
      ];
    },
    ...
    whenValidate: function whenValidate(group, force, event) {
      ...
      return $.when
        ...
        .pipe(
          promiseBasedOnValidationResult,
          promiseBasedOnValidationResult
        );
    },
  ...
  var registry = (window.Parsley._validatorRegistry = new ParsleyValidatorRegistry(
  ...
  Parsley.addValidator("remote", {
    ...
    validateString: function validateString(value, url, options, instance) {
      ...
      if (url.indexOf("{value}") > -1) {
        ...
        data[
          instance.$element.attr("name") || instance.$element.attr("id")
        ] = value;
      }
